...
void draw_box(int *b)
{
		...
		sprintf(strd, "%c%c%c%c%c%c%c", colors[b[3]], colors[b[3]], colors[b[3]], colors[b[3]], colors[b[3]], colors[b[3]], colors[b[3]]);
		sprintf(stre, "%c%c%c%c%c%c%c%c%c%c", colors[b[4]], colors[b[4]], colors[b[4]], colors[b[4]], colors[b[4]], colors[b[4]], colors[b[4]], colors[b[4]], colors[b[4]], colors[b[4]]);
